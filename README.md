...
1. Экспортируйте данные через кнопку **Экспорт**
2. Зайдите в репозиторий GitHub: https://github.com/1x5/-2
3. Нажмите "Add file" → "Upload files"
4. Выберите экспортированный JSON файл
5. Введите commit message: `Update database`
6. Нажмите "Commit changes"

**Для восстановления данных:**
1. Скачайте файл `data.json` из репозитория
2. Нажмите кнопку **Импорт** в приложении
